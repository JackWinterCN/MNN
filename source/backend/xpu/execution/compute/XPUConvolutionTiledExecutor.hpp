...
public:
    ...
    static void setIm2ColParameter(ConvolutionCommon::Im2ColParameter& dstIm2ColParamter, const Convolution2DCommon* convCommon, Tensor* input, Tensor* output, int padX, int padY, const XPUCoreFunctions* floatCore, const XPUCoreInt8Functions* int8Core, int pack = 0, int32_t* int8GemmUnit = nullptr);
    // Total / Stride
